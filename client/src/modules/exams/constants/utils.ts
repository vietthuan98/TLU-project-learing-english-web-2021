...
export function validateCellData(data: { key: string, value: string | number }): string | undefined {
    ...
    switch (key) {
        ...
        case camelCase(EXCEL_HEADERS.ANSWER):
            ...
            if (!ANSWERS.includes((value as string).toUpperCase())) return 'Answer must be one of A, B, C or D.';
            break;
